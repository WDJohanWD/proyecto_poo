...
class Preguntas:
    ...
    preguntas_entretenimiento = [{
        ...
        {
        "enunciado": "¿Cuál es la serie de televisión más vista de todos los tiempos?",
        "opciones": ["a) Breaking Bad", "b) Game of Thrones", "c) The Sopranos", "d) Friends"],
        "respuesta_correcta": "d"
    }]

    # MÉTODO CONSTRUCTOR
    def __init__(self, archivo: str = 'cosas No CLASES\preguntas.json') -> None:
    ...
    def obtener_pregunta_actual(self) -> list and str:
        return self.pregunta, self.categoría

    # LEER JSON Y UTILIZARLO
...
if __name__ == '__main__':
    preg = Preguntas()
    print(preg.comprobar_respuesta())
